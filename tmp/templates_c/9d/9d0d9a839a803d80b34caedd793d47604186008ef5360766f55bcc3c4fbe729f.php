...
class __TwigTemplate_c4d202e1588a5d3aeb1aaf5272bacefada4d513243eaed7928b3ea146459e758 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            // line 8
            echo "        <a class=\"item ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 8), (isset($context["currentLanguageCode"]) || array_key_exists("currentLanguageCode", $context) ? $context["currentLanguageCode"] : (function () { throw new RuntimeError('Variable "currentLanguageCode" does not exist.', 8, $this->source); })())))) {
                echo "active";
            }
            echo "\"
           value=\"";
...
", "@LanguagesManager/getLanguagesSelector.twig", "/Users/ariq/Sites/matomo/plugins/LanguagesManager/templates/getLanguagesSelector.twig");
    }
}
